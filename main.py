...
class FirstWindow(tk.Tk):
    def __init__(self):
        ...
        self.label = tk.Label(self, text="Welcome to Rotation 1.0!", font=("Arial", 14))
        self.label.pack(pady=10)

        self.label_num = tk.Label(self, text="Number of staff working today:", font=("Arial", 12))
        self.label_num.pack()

        self.entry_num = tk.Entry(self, font=("Arial", 12))
        self.entry_num.pack()

        self.submit = tk.Button(self, text="Submit", command=self.dataCollection, font=("Arial", 12))
...
class NameWindow(tk.Toplevel):
    def __init__(self, parent, num_people):
        ...
        for i in range(num_people):
            label = tk.Label(self, text=f"Person {i+1}:", font=("Arial", 12))
        ...
        self.button_submit = tk.Button(self, text="Submit", command=self.display_names, font=("Arial", 12))
...
class DisplayWindow(tk.Toplevel):
    def __init__(self, parent, names):
        ...
        self.label = tk.Label(self, text=names[self.index], font=("Arial", 14))
        self.label.pack(pady=20)

        self.button = tk.Button(self, text="Next", command=self.next_name, font=("Arial", 12))
